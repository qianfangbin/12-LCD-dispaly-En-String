...
寄存器基地址 = 0X6000 0000, 由于FSMC数据位是16位，内部RAM地址是8bit，实际是舍弃了HADDR[24:0]的第0位。
保留HADDR[24:1]和FSMC_ADDR[23:0]对齐。所以FSMC_ADDR的地址相对寄存器基地址需要左移一位
FSMC A16在内部寄存器上地址 = 0X6002 0000 = 0X6000 0000+2^16*2 = 0X6000 0000 + 0X2 0000 = 0X6002 0000,
此时地址A16地址线为高电平
...
//FSMC_Bank1_NORSRAM用于LCD命令操作的地址 A16低电平
#define      FSMC_Addr_ILI9341_CMD         ( ( uint32_t ) 0x60000000 )

//FSMC_Bank1_NORSRAM用于LCD数据操作的地址 A16高电平      
...
#define      ILI9341_BK_PIN                GPIO_Pin_13
